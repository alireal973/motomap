...
### Tamamlanan Isler (Kapatilacak Issue'lar)
...
- Issue #5 ? Comment: implementasyon detaylari
- Issue #6 ? Comment: retry/fallback mekanizmasi detaylari
