...
export default function RegisterScreen() {
  ...
  const validate = (): string | null => {
    ...
    if (!password) return "Sifre gereklidir";
    if (password.length < 8) return "Sifre en az 8 karakter olmalidir";
    if (!/[A-Z]/.test(password)) return "Sifre buyuk harf icermelidir";
    if (!/[a-z]/.test(password)) return "Sifre kucuk harf icermelidir";
    if (!/[0-9]/.test(password)) return "Sifre rakam icermelidir";
    if (password !== confirmPassword) return "Sifreler eslesmiyor";
    return null;
  };
      ...
      >
        ...
        >
          ...
          <View style={styles.form}>
            <Text style={styles.label}>Gorunen Ad (istege bagli)</Text>
            <TextInput
              style={styles.input}
              placeholder="Adiniz"
